...
- **Model.md**: Technical breakdown of the 1D-CNN architecture, training graphs, and rationale.
- **tinyML.md**: Full MCU environment setup and detailed C firmware implementation logic.
