...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "morse_model"
...
#define AI_NETWORK_IN_1_SIZE        (100)
#define AI_NETWORK_IN_1_SIZE_BYTES  (100)
...
#define AI_NETWORK_OUT_1_CHANNEL     (28)
#define AI_NETWORK_OUT_1_SIZE        (28)
